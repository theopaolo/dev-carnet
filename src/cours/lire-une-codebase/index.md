---
title: 'Lire, comprendre et améliorer une codebase'
order: 4
---
...
1. [Lire du code](/lire-une-codebase/01-lire-du-code/)
2. [Code smells](/lire-une-codebase/02-code-smells/)
3. [Refactoriser](/lire-une-codebase/03-refactoriser/)
4. [Préparer et recevoir une review](/lire-une-codebase/04-preparer-une-review/)
5. [Faire une revue de code constructive](/lire-une-codebase/05-revue-constructive/)
6. [Domain-Driven Design](/lire-une-codebase/06-ddd/)
7. [Annexes](/lire-une-codebase/07-annexes/)
8. [Catégories des variables](/lire-une-codebase/08-variables/)
9. [Vocabulaire](/lire-une-codebase/09-vocabulaire/)
10. [Principes et méthodos](/lire-une-codebase/10-principes/)
