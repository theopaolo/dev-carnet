...
Exercice : ajouter un service d’export aux deux vues C4, libeller son échange puis régénérer les SVG avec npm run docs:diagrams. Demander au binôme qui utilise ce service et quelles données sortent de l’application.
